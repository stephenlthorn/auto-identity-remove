...
/**
 * Write audit markdown to logsDir/audit-YYYY-MM-DD.md.
 *
 * @param {string} logsDir - Directory to write into.
 * @param {string} markdown - Markdown content to write.
 * @param {string} [timestamp] - ISO timestamp used for filename date. Defaults to now.
...
module.exports = { renderAuditMarkdown, writeAuditFile };
